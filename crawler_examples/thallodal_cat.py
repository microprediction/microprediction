...
from microprediction.sequentialcrawler import SequentialStreamCrawler, DigestMachine

if __name__ == "__main__":
    crawler = SequentialStreamCrawler(write_key=THALLODAL_CAT, min_lags=500, machine_type=DigestMachine)

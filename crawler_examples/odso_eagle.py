from microprediction.config_private import ODSO_EAGLE
...
class MyCrawler(MicroCrawler):
    ...
    def candidate_streams(self):  # can use this to exclude troublesome streams, or just delete
        ...
        good_names = []
        candidate_names = [name for name, sponsor in
                           self.get_streams_by_sponsor().items()]  # if name[:1] != 'z' #exclude z streams

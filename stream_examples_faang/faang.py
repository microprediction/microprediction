...
def scaled_portfolio_return(changes, w:[float]):
    ...
    f = np.exp( changes/1000.)
    change = 1000*math.log( np.inner(w,f) )
    return change
...
if __name__=='__main__':
    ...
    mcp = MultiChangePoll(write_key=WRITE_KEY, names = names, interval=1, func=scaled_log_faang, with_copulas=False,

...
second assertion I make. You can [publish live data](https://microprediction.github.io/microprediction/publish.html) such as your own prediction model errors. This will create a market immediately where bots and their authors will try to find signal that you missed. The only question is whether you are
[quick to grok this](https://www.linkedin.com/posts/thomashthoresen_datascience-microprediction-timeseriesforecasting-activity-6999971006274514944-lDID?utm_source=share&utm_medium=member_desktop) or not. 

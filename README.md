...
| Site | Content |
|---|---|
| [home.microprediction.org](https://home.microprediction.org) or [microprediction/home](https://github.com/microprediction/home/) | Papers, posts etc |
...
I'm a career quant, applied mathematician, open-source developer, entrepreneur and father of three girls. My interests include quantitative finance, collective intelligence, sports analytics and mathematics in general. GitHub decided this should be my home page but this repo used to be the client for a high velocity prediction market I wrote for Intech Investments. It collected a billion predictions. 

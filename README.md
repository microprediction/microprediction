...
### Interests
 ...
 - Derivative-free optimization (see [humpday](https://github.com/microprediction/humpday))
 - Time-series (see [timemachines](https://github.com/microprediction/timemachines))
 - Sports analytics 

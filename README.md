...
Looking for [microprediction](https://github.com/microprediction/microprediction/tree/master/microprediction) client, or the [precise](https://github.com/microprediction/precise) or 
[timemachines](https://github.com/microprediction/timemachines) packages? Github made this page, which was supposed to be the microprediction platform client page, a "user page" so we'll try to accomplish both here. Hi, this is my [dog](https://i.imgur.com/2E3pskp.jpg). This is my [blog](https://www.microprediction.com/blog). I run a slack channel for those interested in open-source time-series prediction ([Slack invite](https://join.slack.com/t/microprediction/shared_invite/zt-11qt4brxu-6C~rPuUifALpXsvtN4SweA)) and informal Google Meets twice a week announced in the Slack (Tue 8pm and Fri noon EST). If that link requires an email domain, it has expired so DM [me](https://www.linkedin.com/petercotton) on Linked-In for a new one. 

### The autonomous community prediction TLDR:

...
| [conformalprediction.net](https://conformalprediction.net) | Provides a KL-divergence theorem explaining clearly the limitations of conformal prediction. The site is a a practical guide explaining when to use conformal prediction and what its rigorous guarrantee does not provide. |

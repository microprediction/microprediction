...
- [HumpDay](https://github.com/microprediction/humpday) - Global optimizer canonical form, [Elo ratings](https://github.com/microprediction/optimizer-elo-ratings) and selection (fluid). 

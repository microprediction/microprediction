...
So yeah, the [book](https://mitpress.mit.edu/books/microprediction) was a meditation on the power of mini-markets and algorithmic statistical agents predating LLMs and missing that important context (also predating phrases like "DeAI" and "Info Finance" (Buterin) not to mention the general explosion of interst in prediction markest. I guess you can read the [awards and reviews](https://microprediction.github.io/building_an_open_ai_network/feedback.html) or chat with the [Microprediction GPT](https://chatgpt.com/g/g-68a5be41f36081918babe673c975b453-microprediction-the-book).

...
- [HumpDay](https://github.com/microprediction/humpday) - Global optimizer canonical form, Elo ratings and comparisons.
- [TimeMachines](https://github.com/microprediction/timemachines) - Time-series algorithms in simple functional form.
...
- [Winning](https://github.com/microprediction/winning) - A fast algorithm for inferring relative ability from win probability. 
...
This package is a Python client for the [microprediction api](http://api.microprediction.org/), enabling turnkey, *repeated short term predictions* of anything, for any purpose, for anyone, at any time. This project is new, but simple in principle. It is in active use by two leading financial institutions. There is a site [microprediction.com](https://www.microprediction.com/) that can be considered a resource and introduction to [microprediction.org](https://www.microprediction.org) where the action happens. 

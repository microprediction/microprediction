import time
try:
    from credentials import ESTADO_SOLE as WRITE_KEY
except:
    raise Exception('You need to change this part of the code')
    # new_key(difficulty=11) will create a key for you

...
import numpy as np
try:
    from microprediction.config_private import DOODLE_MAMMAL
except:
    DOODLE_MAMMAL=None

def test_repo_live():
    if DOODLE_MAMMAL is not None:
        mw = MicroWriter(write_key=DOODLE_MAMMAL,base_url='https://devapi.microprediction.org')
